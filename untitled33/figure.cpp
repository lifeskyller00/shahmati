...
void figure::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    if (clas==1)
    painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/peshka1"));
    else if (clas==5)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/ladya1"));
    else if (clas==6)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/korol1"));
    else if (clas==4)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/ferz1"));
    else if (clas==3)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/Kon1"));
    else if (clas==2)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/Slon1"));
    else if (clas==11)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/peshka2"));
    else if (clas==15)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/ladya2"));
    else if (clas==16)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/korol2"));
    else if (clas==14)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/ferz2"));
    else if (clas==13)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/kon2"));
    else if (clas==12)
     painter->drawPixmap(-13,-30,27,60,QPixmap("C:/Users/79018/Desktop/chesses/slon2"));
    Q_UNUSED(option);
    Q_UNUSED(widget);
